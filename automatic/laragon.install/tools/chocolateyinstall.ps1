...
$packageArgs = @{
  ...
  fileType      = 'EXE'
  url64         = 'https://github.com//leokhoa/laragon/releases/download/8.6.0/laragon-wamp.exe'

  checksum64    = '814b7a2cfafc71a622634891f5be489557414ad7cf98b96c199ecce7f31f50a5'
  checksumType  = 'sha256'
