...
$packageArgs = @{
  ...
  url           = 'https://github.com//logisim-evolution/logisim-evolution/releases/download/v5.0.0/logisim-evolution-5.0.0-all.jar'
  checksum      = '6b368e894742c04cc83aa9830f869bcab0190ede4df43ad6fecdb89b3a23a41c'
  checksumType  = 'sha256'
}
