...
$packageArgs = @{
  ...
  url           = 'http://ftp.fau.de/eclipse/technology/epp/downloads/release/2024-12/R/eclipse-cpp-2024-12-R-win32-x86_64.zip'
  checksum      = 'd559509cf700c73b901f3066fa1656b6bc42b8844839bd302e59694f758cdf13'
  checksumType  = 'sha256'
}
