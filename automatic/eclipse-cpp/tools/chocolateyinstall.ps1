...
$packageArgs = @{
  ...
  url           = 'http://ftp.fau.de/eclipse/technology/epp/downloads/release/2026-06/R/eclipse-cpp-2026-06-R-win32-x86_64.zip'
  checksum      = '76455cd8a9ebd46fd1cfff77e838d2ce622bff4abdbb01d6f9b1ecf499f941a0'
  checksumType  = 'sha256'
}
