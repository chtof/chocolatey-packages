...
$packageArgs = @{
  ...
  url64         = 'https://download.sublimetext.com/sublime_merge_build_2128_x64_setup.exe'
  checksum64    = 'c11088e314463e3f2050752b3ec814410ac87ca3daa1e0b54866c7afbaff4540'
  checksumType  = 'sha256'
