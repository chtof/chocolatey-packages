...
$packageArgs = @{
  ...
  file          = "$toolsDir\luanti-5.13.0-win32.zip"
  file64        = "$toolsDir\luanti-5.13.0-win64.zip"
}
...
$targetPath = Join-Path "$toolsLocation" "luanti-5.13.0-win$(Get-OSArchitectureWidth)\bin\minetest.exe"
