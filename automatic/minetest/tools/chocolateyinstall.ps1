...
$packageArgs = @{
  ...
  file          = "$toolsDir\luanti-5.15.1-win32.zip"
  file64        = "$toolsDir\luanti-5.15.1-win64.zip"
}
...
$targetPath = Join-Path "$toolsLocation" "luanti-5.15.1-win$(Get-OSArchitectureWidth)\bin\minetest.exe"
