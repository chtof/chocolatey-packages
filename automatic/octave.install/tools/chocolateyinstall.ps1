...
$packageArgs = @{
  ...
  url64         = 'https://ftpmirror.gnu.org/octave/windows/octave-11.1.0-w64-installer.exe'
  checksum64    = '0cea50429cb83010d0f10bbdecaf33928663dae9ba8739d9492045251d72b128'
