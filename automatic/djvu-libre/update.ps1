...
function global:au_GetLatest {
    ...
    return @{
        ...
        URL32 = (Get-RedirectedUrl ('https://downloads.sourceforge.net/project/djvu/DjVuLibre_Windows/' + $matches.Version + '+' + $matches.VersionDjView + '/DjVuLibre-' + $matches.Version + '_DjView-' + $matches.VersionDjView + '_Setup.exe')) -Replace ('\?viasf=.*', '')
    }
}
